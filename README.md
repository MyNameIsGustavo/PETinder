...
<p>Buscando atender a demanda deste mercado, desenvolveremos uma aplicação WEB que envolverá os aspectos necessários para a organização de um petshop, como por exemplo: cadastramento de pets, serviços prestados, compras de acessórios, produtos e dashboard. Portanto, será desenvolvido tudo que é necessário para um sistema de gerenciador de petshop online.</p>

<p>A decisão de ser uma aplicação WEB se fez necessária para atingir o maior número de pessoas possíveis. Dessa forma, tornando-se uma aplicação escalável desde o seu surgimento. Além disso, o projeto contará com um serviço de hospedagem próprio para demonstração do produto.</p>

<p>Na primeira tela de cadastro irá conter as informações dos usuários que podem ser tanto os clientes, quanto os vendedores ou doadores. Nessa tela de cadastro entre as principais  informações teremos os dados básicos de nossos clientes, como por exemplo: nome, endereço, contatos e entre outros.</p>
...
<p>Na parte de compras de acessórios e produtos terão materiais cadastrados pelos próprios usuários, onde será similar com a prestação de serviços, tendo por sua vez um catálogo que disponibiliza aos clientes produtos vendidos pela loja em questão.</p>

<p>O dashboard irá conter as informações básicas, e servirá como apoio para inserir informações sobre futuros eventos ou promoções. O acréscimo de um dashboard ao sistema se faz necessário tendo em vista a facilitação e praticidade para a visualização dos dados inseridos de maneira mais analítica e simples em um determinado período desejado. Criando dessa forma uma solução útil para o nosso cliente que antes tratava tudo de maneira informal e manual.</p>
